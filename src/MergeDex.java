...
public class MergeDex {
    public static void doMerge(String shellDexPath, String apkPath, String outputPath) {
        try {
            File payloadSrcFile = new File(apkPath);
            File unShellDexFile = new File(shellDexPath);
            byte[] payloadArray = encrypt(readFileBytes(payloadSrcFile), Config.DEX_DES_KEY);
...
/*
    ...
    private static byte[] encrypt(byte[] srcData, String key) {
        try {
